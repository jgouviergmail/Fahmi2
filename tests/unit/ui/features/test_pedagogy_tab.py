"""Smoke test de l'onglet PedagogyTab réel."""
...
def test_pedagogy_tab_constructs_and_handles_selection(
    ...
    assert tab.feature_id is FeatureId.PEDAGOGY
    assert tab.title == "Supports pédagogiques"
    ...
    # Ne doit pas lever (projet non configuré pour la pédagogie).
